...
const GITHUB_DEMO_COMMENT_NAMESPACE_REPO =
  "b6pzeusbc54tvhw5jgpyw8pwz2x6gs/aluc-io-comment";
      ...
      <div className="App">
        <header className="App-header">
          ...
          <p className="App-intro">
            <a href="https://www.npmjs.com/package/react-utterances">
              react-utterances
            </a>{" "}
            is the react component for{" "}
            <a href="https://utteranc.es">utterances</a> that is a lightweight
            comments widget built on GitHub issues. To get started, checkout{" "}
          ...
          <div className="Status-Buttons">
            ...
            <a
              className="github-button"
              href={`https://github.com/${GITHUB_NAMESPACE}`}
              data-size="large"
              aria-label="Follow @alfreduc on GitHub"
            >
              Follow @alfreduc
            </a>
        ...
        <GithubCorner href={GITHUB_COMPONENT_REPO_URL} bannerColor="#886ce4" />
      </div>
    );
  }
}
